...
int pttrap106 (s1, s2)	/* strings equal */
    char *s1, *s2;
    {
	if (strcmp (s1, s2) == 0) 
	    return (1);
...
pttrap107 (string, fileNumber)	/* read string */
    char  *string;
    int   fileNumber;
    {
...
pttrap108 (fieldWidth, string, fileNumber)	/* write string */
    char  *string;
...
int pttrap109 (s1, s2)	/* string index */
    char  *s1, *s2;
    {
	char *x;
	x = strstr (s1, s2);
