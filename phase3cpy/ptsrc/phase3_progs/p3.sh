...
#if ("$2"=="m") then
echo
ssltrace "ptc -o3 -t3 -L "$ptc_path" "$1"" "$semantic_path" #| egrep '^ *[\.o%]'
echo
#fi
echo
echo Cordys Version
...
#if ("$2"=="m") then
echo
#ssltrace "ptc -L /cas/course/cisc458/jt/lib -o3 -t3 "$1"" /cas/course/cisc458/jt/lib/semantic.def -moie # | egrep '^ *[\.o%]'
echo
#fi
